      ...
      <div class="page-inner">
        ...
        <header class="page-title-bar">
                ...
                <div class="d-md-flex align-items-md-start">
                  <h1 class="page-title mr-sm-auto"> Cập nhật nhân viên </h1>
                </div>
            <!-- /title and toolbar -->
        </header>
          ...
          <section class="card card-fluid">
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <form class="needs-validation was-validated" novalidate="" action="{{ route('admin.nhanvien.sua',['id'=> $nhanvien->id]) }}" method="post" enctype="multipart/form-data">
                  @csrf
                  <div class="row">
                      <div class="col-md-6">
                          ...
                          <select class="custom-select d-block w-100 @error('doanhnghiep_id') is-invalid @enderror" id="doanhnghiep_id" name="doanhnghiep_id" required>
                            <option value="" >-- Chọn Doanh Nghiệp --</option>
                             @foreach($doanhnghiep as $value)
                                <option value="{{ $value->id }}" {{ ($nhanvien->doanhnghiep_id == $value->id) ? 'selected' : '' }}>{{ $value->tendoanhnghiep }}</option>
                             @endforeach
                          </select>
                  ...
                  <div class="row">
                          ...
                          <select class="custom-select d-block w-100 @error('tinh_id') is-invalid @enderror" id="tinh_id" name="tinh_id" required>
                            <option value="" selected disabled>-- Chọn Tỉnh/Thành Phố --</option>
                             @foreach($tinh as $value)
                                <option value="{{ $value->id }}" {{ ($nhanvien->tinh_id == $value->id) ? 'selected' : '' }}>{{ $value->tentinh }}</option>
                             @endforeach
                          </select>
                      ...
                      <div class="col-md-3">
                              ...
                              <select class="custom-select d-block w-100 @error('huyen_id') is-invalid @enderror" id="huyen_id" name="huyen_id" required>
                                 ...
                                 @foreach($huyen as $value)
                                    <option value="{{ $value->id }}" {{ ($nhanvien->huyen_id == $value->id) ? 'selected' : '' }}>{{ $value->tenhuyen }}</option>
                                 @endforeach
                              </select>
                      ...
                      <div class="col-md-3">
                              ...
                              <select class="custom-select d-block w-100 @error('xa_id') is-invalid @enderror" id="xa_id" name="xa_id" required>
                                @foreach($xa as $value)
                                    <option value="{{ $value->id }}" {{ ($nhanvien->xa_id == $value->id) ? 'selected' : '' }}>{{ $value->tenxa }}</option>
                                 @endforeach
                              </select>
                           ...
                           <div class="col-md-3">
                              ...
                              <input type="text" class="form-control @error('tenduong') is-invalid @enderror" id="tenduong" name="tenduong" value="{{ $nhanvien->tenduong }}" placeholder="Tên Đường/Số Nhà" required />
                   ...
                   <div class="row">
                      ...
                      <input type="text" class="form-control @error('tennhanvien') is-invalid @enderror" id="tennhanvien" name="tennhanvien" value="{{ $nhanvien->tennhanvien }}" placeholder="Họ Và Tên Nhân Viên" required />
                      ...
                      <div class="col-md-3">
                          ...
                          <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ $nhanvien->email }}" placeholder="Địa Chỉ Email" required />
                      ...
                      <div class="col-md-3">
                          ...
                          <input type="text" class="form-control @error('CMND') is-invalid @enderror" id="CMND" name="CMND" value="{{ $nhanvien->CMND }}" placeholder="CMND/CCCD" required />
                      ...
                      <div class="col-md-3">
                          ...
                          <input type="text" class="form-control @error('SDT') is-invalid @enderror" id="SDT" name="SDT" value="{{ $nhanvien->SDT }}" placeholder="Điện Thoại" required />
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      ...
                      <div class="col-md-4">
                         ...
                         @if(!empty($nhanvien->hinhanh))
                         <img class="d-block rounded" src="{{env('APP_URL').'/storage/app/'.$nhanvien->hinhanh}}" width="100" />
                         <span class="d-block small text-danger">Bỏ trống nếu muốn giữ nguyên ảnh cũ.</span>
                         @endif
                        <input type="file" class="form-control @error('hinhanh') is-invalid @enderror" id="hinhanh" name="hinhanh" value="{{ $nhanvien->hinhanh }}" />
                         @error('hinhanh')
                            <div class="invalid-feedback"><strong>{{ $message }}</strong></div>
                         @enderror
                     </div>
