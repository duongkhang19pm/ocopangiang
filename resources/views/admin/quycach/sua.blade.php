        ...
        <header class="page-title-bar">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                  <a href="{{ route('admin.quycach') }}">Danh Sách</a>
                ...
                <div class="d-md-flex align-items-md-start">
                  <h1 class="page-title mr-sm-auto"> Cập Nhật Quy Cách Đóng Gói </h1>
                </div>
            <!-- /title and toolbar -->
        </header>
          ...
          <section class="card card-fluid">
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <form class="needs-validation was-validated" novalidate="" action="{{ route('admin.quycach.sua',['id'=> $quycach->id]) }}" method="post">
                  @csrf
                 ...
                 <div class="form-group">
                          ...
                          <select class="custom-select d-block w-100 @error('donvitinh_id') is-invalid @enderror" id="donvitinh_id" name="donvitinh_id" required>
                            <option value="">-- Chọn nhóm --</option>
                             @foreach($donvitinh as $value)
                                <option value="{{ $value->id }}" {{ ($quycach->donvitinh_id == $value->id) ? 'selected' : '' }}>{{ $value->tendonvitinh }}</option>
                             @endforeach
                          </select>
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control @error('tenquycach') is-invalid @enderror" id="tenquycach" name="tenquycach" value="{{$quycach->tenquycach}}"required />
