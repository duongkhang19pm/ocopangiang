        ...
        <header class="page-title-bar">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                  <a href="{{ route('doanhnghiep.baiviet') }}">Danh Sách</a>
          ...
          <section class="card card-fluid">
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <form class="needs-validation was-validated" novalidate="" action="{{ route('doanhnghiep.baiviet.them') }}" method="post" enctype="multipart/form-data">
                  @csrf
