          ...
          <section class="card card-fluid">
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <form class="needs-validation was-validated" novalidate="" action="{{ route('admin.doanhnghiep.sua',['id'=> $doanhnghiep->id]) }}" method="post" enctype="multipart/form-data">
                  @csrf
                  <div class="row">
                      <div class="col-md-6">
        ...
        $(document).ready(function(){
            ...
            $('#tinh_id').change(function() {
                ...
                if (tinhID) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "{{ route('admin.doanhnghiep.getHuyen') }}?tinh_id=" + tinhID,
            ...
            $('#huyen_id').on('change', function() {
                ...
                if (huyenID) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "{{ route('admin.doanhnghiep.getXa') }}?huyen_id=" + huyenID,
                        success: function(res) {
