        ...
        <div class="container">
            ...
            <div class="row featured__filter">
                ...
                @foreach($sanpham as $value)
                    ...
                    @endphp
                    @if($dem = $max)
                        <div class="col-lg-3 col-md-4 col-sm-6 mix " id="myTextField" >
                            ...
                            <div class="featured__item">
                                    ...
                                    <div class="featured__item__pic set-bg" data-setbg="{{env('APP_URL').'/storage/app/'.$value->hinhanh  }}">
                                        ...
                                        @else
                                            ...
                                            @endif
                                        @endguest
                                            <li><a href="{{ route('frontend.sanpham.chitiet', ['tennhom_slug' => $value->loaisanpham->nhomsanpham->tennhom_slug,'tenloai_slug' => $value->loaisanpham->tenloai_slug,'tensanpham_slug' => $value->tensanpham_slug]) }}"><i class="fa fa-eye">{{$value->luotxem}}</i></a></li>
                                            <li><a href="{{ route('frontend.giohang.them', ['tensanpham_slug' => $value->tensanpham_slug]) }}" ><i class="fa fa-shopping-cart"></i></a></li>
                                        </ul>
                                    </div>
            ...
            <div class="section-title from-blog__title">
                <form action="{{route('frontend.sanpham.show')}}" method = "post">
                @csrf
                <input type="hidden" id="show" name ="show" value ="{{$sanpham->count()}}"/>
                <button type="submit" class="site-btn" >Xem Thêm 12 Sản Phẩm</button>
                </form>
