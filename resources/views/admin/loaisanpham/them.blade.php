      ...
      <div class="page-inner">
        ...
        <header class="page-title-bar">
                ...
                <div class="d-md-flex align-items-md-start">
                  <h1 class="page-title mr-sm-auto"> Thêm loại sản phẩm </h1>
                </div>
            <!-- /title and toolbar -->
        </header>
          ...
          <section class="card card-fluid">
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <form class="needs-validation was-validated" novalidate="" action="{{ route('admin.loaisanpham.them') }}" method="post">
                  @csrf
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control @error('tenloai') is-invalid @enderror" id="tenloai" name="tenloai" value="{{ old('tenloai') }}" placeholder="Loại Sản Phẩm" required />
