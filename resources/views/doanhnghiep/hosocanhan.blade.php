    ...
    <nav class="page-navs">
      ...
      <div class="nav-scroller">
        ...
        <div class="nav nav-center nav-tabs">
          ...
          <a class="nav-link active" href="{{ route('doanhnghiep.hosocanhan',['id'=> Auth::user()->id]) }}">Hồ Sơ Cá Nhân</a>
          <a class="nav-link" href="{{ route('doanhnghiep.baivietcanhan',['id'=> $taikhoan->id]) }}">Bài Viết Của Tôi <small class="badge">{{count($baiviet)}}</small></a> 
        ...
        <div class="row">
          ...
          <div class="col-lg-10">
            ...
            <div class="card card-fluid">
              ...
              <div class="card-body">
                <!-- .media -->
                 <form class="needs-validation was-validated" novalidate="" action="{{ route('doanhnghiep.hosocanhan',['id'=> $taikhoan->id]) }}" method="post" enctype="multipart/form-data">
                  @csrf
        ...
        $(document).ready(function(){
            ...
            $('#tinh_id').change(function() {
                ...
                if (tinhID) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "{{ route('doanhnghiep.getHuyen') }}?tinh_id=" + tinhID,
            ...
            $('#huyen_id').on('change', function() {
                ...
                if (huyenID) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "{{ route('doanhnghiep.getXa') }}?huyen_id=" + huyenID,
                        success: function(res) {
