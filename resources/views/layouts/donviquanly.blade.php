            ...
            @auth
              <div class="dropdown d-none d-md-flex">
                ...
                <div class="dropdown-menu">
                  ...
                  <a class="dropdown-item" href="{{ route('donviquanly.hosocanhan',['id'=> Auth::user()->id]) }}"><span class="dropdown-icon oi oi-person"></span> Hồ Sơ Cá Nhân</a>
        ...
        @else
          ...
          <header class="aside-header d-block d-md-none">
            ...
            <div id="dropdown-aside" class="dropdown-aside collapse">
              <!-- dropdown-items -->
              <div class="pb-3">
                <a class="dropdown-item" href="{{ route('donviquanly.hosocanhan',['id'=> Auth::user()->id]) }}">
            ...
            <nav id="stacked-menu" class="stacked-menu">
              ...
              <ul class="menu">
                ...
                <li class="menu-item has-active">
                  <a href="{{route('donviquanly.home')}}" class="menu-link">
