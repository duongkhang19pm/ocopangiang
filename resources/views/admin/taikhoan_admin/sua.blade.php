          ...
          <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <div class="d-md-flex align-items-md-start">
                  <h1 class="page-title mr-sm-auto"> Cập Nhật Tài Khoản Quản Trị Viên </h1>
                </div>
            <!-- /title and toolbar -->
        </header>
          ...
          <section class="card card-fluid">
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <form class="needs-validation was-validated" novalidate="" action="{{ route('admin.taikhoan_admin.sua',['id'=> $taikhoan->id]) }}" method="post" enctype="multipart/form-data">
                  @csrf
