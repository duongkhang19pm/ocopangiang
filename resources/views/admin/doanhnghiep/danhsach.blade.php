  ...
  <div class="page"><div class="sidebar-backdrop"></div>
        ...
        <div class="page-inner">
          ...
          <header class="page-title-bar">
                ...
                <a type="button" href="{{route('admin.doanhnghiep.them')}}" class="btn btn-success btn-floated">
		                     ...
		                     @foreach($doanhnghiep as $value)
		                         <tr>
		                             ...
		                             <td class="align-middle text-right">
			                              <a href="{{ route('admin.doanhnghiep.sua', ['id' => $value->id]) }}" class="btn btn-sm btn-secondary">
			                                <i class="fa fa-pencil-alt"></i>
			                                <span class="sr-only">Edit</span>
			                              </a>
			                              <a   href="{{ route('admin.doanhnghiep.xoa', ['id' => $value->id]) }}" class="btn btn-sm btn-secondary">
