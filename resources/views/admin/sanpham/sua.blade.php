          ...
          <section class="card card-fluid">
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <form class="needs-validation was-validated" novalidate="" action="{{ route('admin.sanpham.sua',['id'=> $sanpham->id]) }}" method="post" enctype="multipart/form-data">
                  @csrf
                  <div class="row">
                       <div class="col-md-6">
                 ...
                 <div class="row">
                          ...
                          <select class="custom-select d-block w-100 @error('doanhnghiep_id') is-invalid @enderror" id="doanhnghiep_id" name="doanhnghiep_id" required>
                            <option value="" >-- Chọn Doanh Nghiệp --</option>
                             @foreach($doanhnghiep as $value)
                                <option value="{{ $value->id }}" {{ ($sanpham->doanhnghiep_id == $value->id) ? 'selected' : '' }}>{{ $value->tendoanhnghiep }}</option>
                             @endforeach
                          </select>
                              ...
                              <select class="custom-select d-block w-100 @error('phanhang_id') is-invalid @enderror" id="phanhang_id" name="phanhang_id"  required>
                               <option value="" >-- Chọn Phân Hạng --</option>
                                 @foreach($phanhang as $value)
                                    <option value="{{ $value->id }}" {{ ($sanpham->phanhang_id == $value->id) ? 'selected' : '' }}>{{ $value->tenphanhang }}</option>
                                 @endforeach
                              </select>
                   ...
                   <div class="row">
                      ...
                      <div class="col-md-3">
                          ...
                          <input type="text" class="form-control @error('nguyenlieu') is-invalid @enderror" id="nguyenlieu" name="nguyenlieu" value="{{ $sanpham->nguyenlieu }}" placeholder="Nguyên Liệu" required />
