              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" style="">
                  <div class="dropdown-arrow"></div>
                    <a href="{{route('admin.nhomsanpham.them')}}" class="dropdown-item"><i class="fa fa-plus mr-2"></i>Thêm Mới</a> 
                                ...
                                <div class="dropdown">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-right" style="">
                                    <div class="dropdown-arrow"></div>
                                      ...
                                      <a href="{{ route('admin.nhomsanpham.sua', ['id' => $value->id]) }}" class="dropdown-item">Cập Nhật</a> 
                                      <a href="{{ route('admin.nhomsanpham.xoa', ['id' => $value->id]) }}" onclick="return confirm('Bạn có muốn xóa nhóm sản phẩm {{ $value->tennhom}} không?')" class="dropdown-item">Xóa</a>
                                  </div>
                                </div>
