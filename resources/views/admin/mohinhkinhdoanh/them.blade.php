          ...
          <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <div class="d-md-flex align-items-md-start">
                  <h1 class="page-title mr-sm-auto"> Thêm Mô Hình Kinh Doanh </h1>
                </div>
            <!-- /title and toolbar -->
        </header>
          ...
          <section class="card card-fluid">
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <form class="needs-validation was-validated" novalidate="" action="{{ route('admin.mohinhkinhdoanh.them') }}" method="post">
                  @csrf
                  <!-- .form-group -->
                  <div class="form-group">
                      <label for="tenmohinhkinhdoanh">Tên mô hình kinh doanh <span class="text-danger font-weight-bold">*</span></label>
                      <input type="text" class="form-control @error('tenmohinhkinhdoanh') is-invalid @enderror" id="tenmohinhkinhdoanh" name="tenmohinhkinhdoanh" value="{{ old('tenmohinhkinhdoanh') }}" placeholder="Mô Hình Kinh Doanh" required />
