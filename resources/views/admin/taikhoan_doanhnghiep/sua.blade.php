          ...
          <section class="card card-fluid">
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <form class="needs-validation was-validated" novalidate="" action="{{ route('admin.taikhoan_doanhnghiep.sua',['id'=> $taikhoan->id]) }}" method="post" enctype="multipart/form-data">
                  @csrf
                  <div class="row">
                      <div class="col-md-3">
        ...
        $(document).ready(function(){
            ...
            $('#tinh_id').change(function() {
                ...
                if (tinhID) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "{{ route('admin.taikhoan_doanhnghiep.getHuyen') }}?tinh_id=" + tinhID,
            ...
            $('#huyen_id').on('change', function() {
                ...
                if (huyenID) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "{{ route('admin.taikhoan_doanhnghiep.getXa') }}?huyen_id=" + huyenID,
                        success: function(res) {
