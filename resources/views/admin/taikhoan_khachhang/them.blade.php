          ...
          <section class="card card-fluid">
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <form class="needs-validation was-validated" novalidate="" action="{{ route('admin.taikhoan_khachhang.them') }}" method="post" enctype="multipart/form-data">
                  @csrf
                  <!-- .form-group -->
        ...
        $(document).ready(function(){
            ...
            $('#tinh_id').change(function() {
                ...
                if (tinhID) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "{{ route('admin.taikhoan_khachhang.getHuyen') }}?tinh_id=" + tinhID,
            ...
            $('#huyen_id').on('change', function() {
                ...
                if (huyenID) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "{{ route('admin.taikhoan_khachhang.getXa') }}?huyen_id=" + huyenID,
                        success: function(res) {
