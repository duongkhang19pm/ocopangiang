...
<body>
    ...
    <p>- Địa chỉ giao: <strong>{{ $donhang->tenduong }} - {{ $donhang->Xa->tenxa }} - {{ $donhang->Xa->Huyen->tenhuyen }} - {{ $donhang->Xa->Huyen->Tinh->tentinh }}   </strong></p>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="text-align:right"><strong>{{ number_format($donhang->Xa->Huyen->phivanchuyen) }}</strong><sup><u>đ</u></sup></td>
        </tr>
            <tr>
                
            <td colspan="4" class="text-left">Tổng tiền sản phẩm:</td>
            <td style="text-align:right"><strong>{{ number_format($tongtien + $donhang->Xa->Huyen->phivanchuyen) }}</strong><sup><u>đ</u></sup></td>
        </tr>
