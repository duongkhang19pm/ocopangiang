        ...
        <header class="page-title-bar">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                  <a href="{{ route('admin.chude') }}">Danh Sách</a>
                ...
                <div class="d-md-flex align-items-md-start">
                  <h1 class="page-title mr-sm-auto"> Cập Nhật Chủ Đề </h1>
                </div>
            <!-- /title and toolbar -->
        </header>
          ...
          <section class="card card-fluid">
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <form class="needs-validation was-validated" novalidate="" action="{{ route('admin.chude.sua',['id'=> $chude->id]) }}" method="post">
                  @csrf
                  <!-- .form-group -->
