              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" style="">
                  <div class="dropdown-arrow"></div>
                    <a href="{{route('doanhnghiep.baiviet.them')}}" class="dropdown-item"><i class="fa fa-plus mr-2"></i>Thêm Mới</a> 
		                             	...
		                             	<div class="dropdown">
								                    ...
								                    <div class="dropdown-menu dropdown-menu-right" style="">
								                      <div class="dropdown-arrow"></div>
								                        ...
								                        <a href="{{ route('doanhnghiep.baiviet.xoa', ['id' => $value->id]) }}" onclick="return confirm('Bạn có muốn xóa bài viết {{ $value->tieude}} không?')" class="dropdown-item">Xóa</a>
								                    </div>
								                  </div>
