...
<head>
	...
	<title>404 - {{ config('app.short_name', 'Laravel') }}</title>
			...
			<div class="card">
				...
				<div class="card-body">
					<div class="state-figure">
						<img class="img-fluid" src="{{ asset('public/backend/images/404.png') }}" style="max-width:300px;" />
					</div>
					<h3 class="state-header">Lỗi 404 - Không tìm thấy trang!</h3>
					<p class="state-description lead">Liên kết trang bị lỗi hoặc trang này không còn tồn tại trên hệ thống!</p>
