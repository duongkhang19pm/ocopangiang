        ...
        <div class="page-inner">
          ...
          <header class="page-title-bar">   
            ...
            <div class="d-md-flex align-items-md-start">
              <h1 class="page-title mr-sm-auto"> Sản Phẩm Sắp Hết </h1>
              <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" style="">
                  <div class="dropdown-arrow"></div>
                    <a href="{{ route('doanhnghiep.sanpham_saphet.xuat') }}"class="dropdown-item"><i class="oi oi-data-transfer-download mr-2"></i>Export</a> 
                </div>
              </div>
            </div>
            <!-- /title and toolbar -->
