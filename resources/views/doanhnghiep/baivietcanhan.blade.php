    ...
    <nav class="page-navs">
      ...
      <div class="nav-scroller">
        ...
        <div class="nav nav-center nav-tabs">
          ...
          <a class="nav-link active" href="{{ route('doanhnghiep.baivietcanhan',['id'=> $taikhoan->id]) }}">Bài Viết Của Tôi <small class="badge">{{count($baiviet)}}</small></a> 
          ...
          <div class="col-lg-6 col-xl-4">
            ...
            <div class="card card-fluid">
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" style="">
                      <div class="dropdown-arrow"></div>
                        <a href="{{ route('doanhnghiep.baiviet_chitiet', ['id' => $value->id]) }}" class="dropdown-item">Xem Chi Tiết</a> 
                        <a href="{{ route('doanhnghiep.baiviet.sua', ['id' => $value->id]) }}" class="dropdown-item">Cập Nhật</a> 
                        <a href="{{ route('doanhnghiep.baiviet.xoa', ['id' => $value->id]) }}" class="dropdown-item">Xóa</a>
                    </div>
                  </div>
                </div>
              </div><!-- /.card-header -->
              ...
              <div class="card-body text-center">
                ...
                <!-- /.media -->
                <h5 class="card-title">
                  <a href="{{ route('doanhnghiep.baiviet_chitiet', ['id' => $value->id]) }}">{{$value->tieude}}</a>
                </h5>
